...
const credentials = {
  ...
  redirect_uris: ['https://ryanviers.github.io/meet/'],
  javascript_origins: ['https://ryanviers.github.io', 'http://localhost:3000'],
};
...
module.exports.getAccessToken = async (event) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    /*The callback in this case is an arrow function with th results as parameters: "err" and "token."*/
